...
public class ProductDetailActivity extends AppCompatActivity {
    ...
    private TextView productPrice, productDescription, productName,productWeight;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        addToCartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                {
                    Toast.makeText(ProductDetailActivity.this, "you can add purchase more products, once your order is confirmed.", Toast.LENGTH_LONG).show();
                }
                else
                {
                    addingToCartList();
                                    ...
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task)
                                        {
                                            if (task.isSuccessful())
                                            {
                                                ...
                                                Intent intent = new Intent(ProductDetailActivity.this, HomesActivtiy.class);
        ...
        productsRef.child(productID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                if (dataSnapshot.exists())
                {
                    ...
                    productWeight.setText(products.getWeight()+"g");
